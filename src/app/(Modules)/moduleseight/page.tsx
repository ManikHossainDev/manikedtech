...
// Image imports
import ImagemodalOne from "@/assets/Modules/Imagemodaleight.png";
    ...
    <div className="fixed inset-0 z-[200] flex md:items-baseline lg:items-center justify-center bg-black bg-opacity-60 backdrop-blur-sm">
      ...
      >
        ...
        <div className="w-full flex justify-between items-center">
          <h1 className="font-semibold text-gray-700">Tilbake til Modul 08</h1>
          <button
            onClick={onClose}
...
export default function CarSceneMerged() {
  ...
  const { data, refetch } = useGetModulesByIdQuery("6936776976dca28d7e43e6c7");
  ...
  const startLearningHandler = async () => {
    try {
      const introBody = { moduleNumber: 8, checkpoint: "intro_page", childProfileId: childId };
      await updateCheckPoints({ updatesBody: introBody }).unwrap();

      const learningBody = { moduleNumber: 8, checkpoint: "learning_content", childProfileId: childId };
