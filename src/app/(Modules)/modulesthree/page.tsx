...
// Image imports
import ImagemodalOne from "@/assets/Modules/imagemodaltow.png";
    ...
    <div className="fixed inset-0 z-[200] flex md:items-baseline lg:items-center justify-center bg-black bg-opacity-60 backdrop-blur-sm">
      ...
      >
        ...
        <div className="w-full flex justify-between items-center">
          <h1 className="font-semibold text-gray-700">Tilbake til Modul 03</h1>
          <button
            onClick={onClose}
...
export default function CarSceneMerged() {
  ...
  const { data, refetch } = useGetModulesByIdQuery("6936619e511d202f50100576");
  ...
  const startLearningHandler = async () => {
    try {
      const introBody = { moduleNumber: 3, checkpoint: "intro_page", childProfileId: childId };
      await updateCheckPoints({ updatesBody: introBody }).unwrap();

      const learningBody = { moduleNumber: 3, checkpoint: "learning_content", childProfileId: childId };
      const response = await updateCheckPoints({ updatesBody: learningBody }).unwrap();

      if (response?.code === 200) {
         router.push(`/Learningthree?childId=${childId}`);
      }
    } catch {
...
// import NRunModules03 from "@/assets/NModules/NRunModules03.png";
// import imagemodaltow from "@/assets/Modules/imagemodaltow.png";
// import tirProint from "@/assets/Modules/tirProint.png";
// import Group from "@/assets/Modules/Group.png";
// import Image from "next/image";
...
//               <div className="md:text-[10px] xl:text-[11px] xxl:text-[13px] tracking-tight leading-tight font-extrabold">
//                 Passord
//               </div>
//               <div className="md:text-[8px] xl:text-[11px] xxl:text-[12px] tracking-tight leading-tight font-extrabold">
//                 & personvern
//               </div>
...
//                       `Protecting private information and digital identity.`}
//                   </h1>
//                 </div>
