...
// Image imports
import ImagemodalOne from "@/assets/Modules/Imagemodalsix.png";
    ...
    <div className="fixed inset-0 z-[200] flex md:items-baseline lg:items-center justify-center bg-black bg-opacity-60 backdrop-blur-sm">
      ...
      >
        ...
        <div className="w-full flex justify-between items-center">
          <h1 className="font-semibold text-gray-700">Tilbake til Modul 06</h1>
          <button
            onClick={onClose}
        ...
        <div className="mt-2">
          ...
          <div className="bg-white flex items-center space-x-2 w-fit py-3 px-2 rounded-br-[38px] rounded-tl-[38px]">
            ...
            <h2 className="text-base md:text-xl font-bold text-[#E58A11]">
              {selectedModule?.title || "Passwords and Privacy 03"}
            </h2>
          </div>
          ...
          <div className="bg-white mt-2 p-2 rounded-md">
            {/* Theme tag */}
            <div className="flex items-center space-x-2 bg-[#FFDFD2] text-black p-2 rounded-xl w-fit">
              <FaLongArrowAltLeft className="text-black"/>
              {selectedModule?.theme || "Protecting private information and digital identity."}
            </div>
...
export default function CarSceneMerged() {
  ...
  const { data, refetch } = useGetModulesByIdQuery("69366f0df4d0d2d1e21e1d67");
  ...
  const startLearningHandler = async () => {
    try {
      const introBody = { moduleNumber: 6, checkpoint: "intro_page", childProfileId: childId };
      await updateCheckPoints({ updatesBody: introBody }).unwrap();

      const learningBody = { moduleNumber: 6, checkpoint: "learning_content", childProfileId: childId };
      const response = await updateCheckPoints({ updatesBody: learningBody }).unwrap();

      if (response?.code === 200) {
         router.push(`/Learningsix?childId=${childId}`);
      }
    } catch {
...
// import NRunModules06 from "@/assets/NModules/NRunModules06.png";
// import Imagemodalsix from "@/assets/Modules/Imagemodalsix.png";
// import tirProint from "@/assets/Modules/tirProint.png";
// import Group from "@/assets/Modules/Group.png";
// import Image from "next/image";
...
//         <div
//           className="absolute top-[15px] right-[100px] sm:top-[40px] sm:right-[140px] md:top-[40px] md:right-[265px] lg:top-[100px] lg:right-[360px]   xl:top-[260px] xl:right-[393px]  xxl:top-[295px] xxl:right-[593px] 3xl:top-[280px] 3xl:right-[600px] 4xl:top-[330px] 4xl:right-[870px]  shadow-lg shadow-[#E58A11]/50 cursor-pointer"
//           onClick={handleDivClick}
//         >
//           <div className="bg-[#E58A11]  px-1 md:py-2 rotate-3 xl:pt-[5px] xl:px-[14px] border border-white rounded-md relative h-full flex flex-col items-center justify-between">
//             {/* Title Section */}
//             <div className="hidden md:block text-center text-white font-black w-full">
//               <div className="md:text-[10px] xl:text-[14px] tracking-tight leading-tight font-extrabold">
//                 Respektfull
//               </div>
//               <div className="md:text-[8px] xl:text-[12px]  font-extrabold">
//                 Kommu-
//                 <h1 className="md:hidden xl:block">nikasjon</h1>
//               </div>
